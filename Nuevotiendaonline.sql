...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2019 a las 05:36:15
...
--
ALTER TABLE `pedido`
  MODIFY `ped_id` int(12) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `fk_fk_ped_id` FOREIGN KEY (`fk_ped_id`) REFERENCES `pedido` (`ped_id`);
