...
<form action="sqleliminarp.php?idProducto=<?php echo $row['idProducto']; ?>"  method="post" >
 ...
 <tr>
  ...
  <tr>
    <th> Categoria:</th>
    <td><input type="text" id="email" class="tabtexto" name="correo" style="width: 98%" value="<?php echo $row['Categoria_idCategoria']; ?>" disabled></td>
  </tr>
</table>
<div>
